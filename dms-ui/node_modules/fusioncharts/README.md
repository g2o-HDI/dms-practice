...
### What's New:
#### FusionCharts
* Events Support for Chord Diagram :hammer_and_wrench:
* Support for CSS Transform :art:
* Improved CSV Export :page_with_curl:
* Other axis, tooltip and legend improvements :chart_with_upwards_trend:

#### FusionTime
* Area Plot Improvements :hammer_and_wrench:
* Improved Data Markers :white_check_mark:
* Other binning, time navigator and range plot improvements :chart_with_upwards_trend:
